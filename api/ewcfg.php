...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "4.0.4");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "kitab"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'pO9pWIIN4igYEFr4', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "kitab.css", // Project stylesheet file name
	"PROJECT_CHARSET" => "", // Project charset
	"IS_UTF8" => FALSE, // Project charset
	"EMAIL_CHARSET" => "", // Email charset
	"HIGHLIGHT_COMPARE" => TRUE, // Highlight compare mode, TRUE(case-insensitive)|FALSE(case-sensitive)
	"PROJECT_ID" => "{92280ED0-5B8E-4CEA-8722-C3BA4553E7D5}", // Project ID (GUID)
	...
	"SIDEBAR_CLASS" => "main-sidebar",
	"NAVBAR_CLASS" => "main-header navbar navbar-expand",
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MYSQL", "qs" => "`", "qe" => "`", "host" => "localhost", "port" => "1234", "user" => "root", "pass" => "70mbanG#1974", "db" => "kitab"]
	],
	...
	"USE_COLORBOX" => FALSE, // Use Colorbox
	...
	// API
	"API_URL" => "index.php", // API accessor URL
	...
	"RESIZE_OPTIONS" => ["keepAspectRatio" => FALSE, "resizeUp" => !FALSE, "jpegQuality" => 100],
	...
	"IMPORT_INSERT_ONLY" => FALSE, // Import by insert only
	...
	"EXPORT_FIELD_IMAGE" => FALSE, // TRUE to export field image
	"EXPORT_CSS_STYLES" => FALSE, // TRUE to export CSS styles
	"EXPORT_MASTER_RECORD" => FALSE, // TRUE to export master record
	"EXPORT_MASTER_RECORD_FOR_CSV" => FALSE, // TRUE to export master record for CSV
	"EXPORT_DETAIL_RECORDS" => FALSE, // TRUE to export detail records
	...
	*/
	...
	// Drill down setting
	"USE_DRILLDOWN_PANEL" => FALSE, // Use popup panel for drill down

	// Filter
	"SHOW_CURRENT_FILTER" => FALSE, // True to show current filter
	"SHOW_DRILLDOWN_FILTER" => FALSE, // True to show drill down filter
