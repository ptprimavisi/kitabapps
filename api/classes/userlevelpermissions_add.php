 ...
 * Page class
 */
class userlevelpermissions_add extends userlevelpermissions
{
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			if (Get("tablename") !== NULL) {
				...
				$this->setKey("tablename", $this->tablename->CurrentValue); // Set up key
			} else {
				$this->setKey("tablename", ""); // Clear key
				$this->CopyRecord = FALSE;
			}
			if ($this->CopyRecord) {
	...
	protected function loadDefaultValues()
	{
		...
		$this->tablename->OldValue = $this->tablename->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['tablename'] = $this->tablename->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// tablename
		$this->tablename->setDbValueDef($rsnew, $this->tablename->CurrentValue, "", FALSE);
