 ...
 * Page class
 */
class kitab_detil_add extends kitab_detil
{
	...
	// Page object name
	public $PageObjName = "kitab_detil_add";
	...
	protected function loadDefaultValues()
	{
		...
		$this->pidsub->CurrentValue = NULL;
		$this->pidsub->OldValue = $this->pidsub->CurrentValue;
		...
		$this->rujukan->CurrentValue = NULL;
		$this->rujukan->OldValue = $this->rujukan->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['pidsub'] = $this->pidsub->CurrentValue;
		...
		$row['rujukan'] = $this->rujukan->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// isi
		$this->isi->setDbValueDef($rsnew, $this->isi->CurrentValue, NULL, FALSE);
		...
		// rujukan
		$this->rujukan->setDbValueDef($rsnew, $this->rujukan->CurrentValue, NULL, FALSE);
