 ...
 * Page class
 */
class userlevels_edit extends userlevels
{
	...
	protected function loadFormValues()
	{
		...
		// Check field name 'userlevelname' first before field var 'userlevelname'
		$val = $CurrentForm->hasValue("userlevelname") ? $CurrentForm->getValue("userlevelname") : $CurrentForm->getValue("userlevelname");
