 ...
 * Page class
 */
class kitab_list extends kitab
{
	...
	// Page object name
	public $PageObjName = "kitab_list";

	// Grid form hidden field names
	public $FormName = "fkitablist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "?" . Config("TABLE_SHOW_DETAIL") . "=";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fkitablistsrch";
	...
	protected function setupListOptions()
	{
		...
		// "detail_kitab_detil"
		$item = &$this->ListOptions->add("detail_kitab_detil");
		$item->CssClass = "text-nowrap";
	...
	public function renderListOptions()
	{
		...
		// "detail_kitab_detil"
		$opt = $this->ListOptions["detail_kitab_detil"];
		if (TRUE) {
			$body = $Language->phrase("DetailLink") . $Language->TablePhrase("kitab_detil", "TblCaption");
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("?" . Config("TABLE_SHOW_MASTER") . "=kitab&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			if ($GLOBALS[""]->DetailView) {
				$caption = $Language->phrase("MasterDetailViewLink");
				$url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=kitab_detil");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailViewTblVar != "")
					$detailViewTblVar .= ",";
				$detailViewTblVar .= "kitab_detil";
			}
			if ($GLOBALS[""]->DetailEdit) {
				$caption = $Language->phrase("MasterDetailEditLink");
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=kitab_detil");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "kitab_detil";
			}
			if ($GLOBALS[""]->DetailAdd) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=kitab_detil");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_kitab_detil");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=kitab_detil");
		if (!isset($GLOBALS["kitab_detil"]))
			$GLOBALS["kitab_detil"] = new kitab_detil();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["kitab_detil"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["kitab_detil"]->DetailAdd);
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
			$detailTableLink .= "kitab_detil";
		}
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fkitablistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fkitablistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fkitablist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
