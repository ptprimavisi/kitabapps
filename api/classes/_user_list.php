 ...
 * Page class
 */
class _user_list extends _user
{
	...
	// Page object name
	public $PageObjName = "_user_list";

	// Grid form hidden field names
	public $FormName = "f_userlist";
	...
	public function __construct()
	{
		...
		// Table object (_user)
		if (!isset($GLOBALS["_user"]) || get_class($GLOBALS["_user"]) == PROJECT_NAMESPACE . "_user") {
			$GLOBALS["_user"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["_user"];
		}
		...
		$this->FilterOptions->TagClassName = "ew-filter-option f_userlistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"f_userlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"f_userlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.f_userlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
	...
	public function loadRowValues($rs = NULL)
	{
		...
		if (array_key_exists('EV__level', $rs->fields)) {
			$this->level->VirtualValue = $rs->fields('EV__level'); // Set up virtual field value
		} else {
			$this->level->VirtualValue = ""; // Clear value
		}
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			// level
			if ($this->level->VirtualValue != "") {
				$this->level->ViewValue = $this->level->VirtualValue;
			} else {
