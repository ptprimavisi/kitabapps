 ...
 * Page class
 */
class userlevelpermissions_view extends userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "userlevelpermissions_view";
	...
	public function __construct()
	{
		...
		if (Get("tablename") !== NULL) {
			$this->RecKey["tablename"] = Get("tablename");
			$keyUrl .= "&amp;tablename=" . urlencode($this->RecKey["tablename"]);
		}
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			...
			if (Get("tablename") !== NULL) {
				...
				$this->RecKey["tablename"] = $this->tablename->QueryStringValue;
			} elseif (IsApi() && Key(1) !== NULL) {
				$this->tablename->setQueryStringValue(Key(1));
				$this->RecKey["tablename"] = $this->tablename->QueryStringValue;
			} elseif (Post("tablename") !== NULL) {
				$this->tablename->setFormValue(Post("tablename"));
				$this->RecKey["tablename"] = $this->tablename->FormValue;
			} elseif (IsApi() && Route(3) !== NULL) {
				$this->tablename->setFormValue(Route(3));
				$this->RecKey["tablename"] = $this->tablename->FormValue;
			} else {
				$returnUrl = ""; // Return to list
			}
