...
/**
 * Table class for v_kitab
 */
class v_kitab extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_kitab';
		$this->TableName = 'v_kitab';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_kitab`";
		$this->Dbid = 'DB';
		...
		// judul
		$this->judul = new DbField('v_kitab', 'v_kitab', 'judul', 'judul', '`judul`', '`judul`', 200, 255, -1, FALSE, '`judul`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->judul->Sortable = FALSE; // Allow sort
		$this->fields['judul'] = &$this->judul;

		// pengarang
		$this->pengarang = new DbField('v_kitab', 'v_kitab', 'pengarang', 'pengarang', '`pengarang`', '`pengarang`', 200, 255, -1, FALSE, '`pengarang`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->pengarang->Sortable = FALSE; // Allow sort
		$this->fields['pengarang'] = &$this->pengarang;

		// sampul
		$this->sampul = new DbField('v_kitab', 'v_kitab', 'sampul', 'sampul', '`sampul`', '`sampul`', 200, 255, -1, TRUE, '`sampul`', FALSE, FALSE, FALSE, 'IMAGE', 'FILE');
		$this->sampul->Sortable = FALSE; // Allow sort
		$this->fields['sampul'] = &$this->sampul;

		// thn_terbit
		$this->thn_terbit = new DbField('v_kitab', 'v_kitab', 'thn_terbit', 'thn_terbit', '`thn_terbit`', '`thn_terbit`', 2, 6, -1, FALSE, '`thn_terbit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// aktif
		$this->aktif = new DbField('v_kitab', 'v_kitab', 'aktif', 'aktif', '`aktif`', '`aktif`', 200, 255, -1, FALSE, '`aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_kitab`";
	}
	...
	public function renderListRow()
	{
		...
		if ($this->sampul->UseColorbox) {
			...
			$this->sampul->LinkAttrs["data-rel"] = "v_kitab_sampul";
