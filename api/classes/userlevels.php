...
class userlevels extends DbTable
{
	...
	public function __construct()
	{
		...
		// userlevelid
		$this->userlevelid = new DbField('userlevels', 'userlevels', 'userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, 11, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new DbField('userlevels', 'userlevels', 'userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, 255, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->userlevelname->Nullable = FALSE; // NOT NULL field
		$this->userlevelname->Required = TRUE; // Required field
		$this->userlevelname->Sortable = FALSE; // Allow sort
	...
	public function renderListRow()
	{
		...
		// userlevelname
		$this->userlevelname->CellCssStyle = "white-space: nowrap;";
