...
export class userlevels extends DbTable {
	pageId: string;
	fieldVars = ["userlevelid","userlevelname"];
	fieldNames = []; // Array([name, var]) for fields with name != var
	listFields: string[] = ["userlevelid","userlevelname"];
	viewFields: string[] = ["userlevelid","userlevelname"];
	addFields: string[] = ["userlevelid","userlevelname"];
	editFields: string[] = ["userlevelid","userlevelname"];
	lookupTables: any = {};
