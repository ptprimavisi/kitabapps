...
// Component
@Component({
	selector: 'page-kitab_detil-view',
	templateUrl: 'kitab_detilview.html',
	styleUrls: ['kitab_detilview.scss']
})
export class kitab_detilViewPage implements OnDestroy, OnInit {
	key: any;
	keyCount: number = 1;
	item: any;
	item$: BehaviorSubject<DbRecord>;
	pageId: string = "view";
	pageUrl: string = "kitab_detilview";
