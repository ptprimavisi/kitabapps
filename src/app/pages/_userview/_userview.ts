...
// Component
@Component({
	selector: 'page-_user-view',
	templateUrl: '_userview.html',
	styleUrls: ['_userview.scss']
})
export class _userViewPage implements OnDestroy, OnInit {
	key: any;
	keyCount: number = 1;
	item: any;
	item$: BehaviorSubject<DbRecord>;
	pageId: string = "view";
	pageUrl: string = "_userview";
