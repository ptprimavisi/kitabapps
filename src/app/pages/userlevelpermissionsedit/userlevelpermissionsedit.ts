...
// Component
@Component({
	selector: 'page-userlevelpermissions-edit',
	templateUrl: 'userlevelpermissionsedit.html',
	styleUrls: ['userlevelpermissionsedit.scss']
})
export class userlevelpermissionsEditPage implements OnDestroy, OnInit {
	key: any;
	keyCount: number = 2;
	item: DbRecord;
	...
	foreignKey: any;
	pageId: string = "edit";
	pageUrl: string = "userlevelpermissionsedit";
