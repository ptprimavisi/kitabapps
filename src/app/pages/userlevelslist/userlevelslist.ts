...
// Component
@Component({
	selector: 'page-userlevels-list',
	templateUrl: 'userlevelslist.html',
	styleUrls: ['userlevelslist.scss']
})
export class userlevelsListPage implements OnDestroy, OnInit {
	...
	async init() {
		...
		await this.user.set("userlevels_foreignKey", this.foreignKey);
