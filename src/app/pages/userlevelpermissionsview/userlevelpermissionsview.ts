...
// Component
@Component({
	selector: 'page-userlevelpermissions-view',
	templateUrl: 'userlevelpermissionsview.html',
	styleUrls: ['userlevelpermissionsview.scss']
})
export class userlevelpermissionsViewPage implements OnDestroy, OnInit {
	key: any;
	keyCount: number = 2;
	item: any;
	item$: BehaviorSubject<DbRecord>;
	pageId: string = "view";
	pageUrl: string = "userlevelpermissionsview";
