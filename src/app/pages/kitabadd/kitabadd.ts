...
// Component
@Component({
	selector: 'page-kitab-add',
	templateUrl: 'kitabadd.html',
	styleUrls: ['kitabadd.scss']
})
export class kitabAddPage implements OnDestroy, OnInit {
	...
	async init() {
		...
		if (this.item) {
			...
			this.item["sampul"].valueChanges.subscribe(files =>
				this.f.fn_sampul.setValue(files));
		}
	}
