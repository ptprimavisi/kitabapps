...
// Component
@Component({
	selector: 'page-kitab_detil-add',
	templateUrl: 'kitab_detiladd.html',
	styleUrls: ['kitab_detiladd.scss']
})
export class kitab_detilAddPage implements OnDestroy, OnInit {
	...
	async init() {
		...
		if (this.item) {
			...
			this.item["gambar"].valueChanges.subscribe(files =>
				this.f.fn_gambar.setValue(files));
		}
	}
