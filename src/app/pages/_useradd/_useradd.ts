...
// Component
@Component({
	selector: 'page-_user-add',
	templateUrl: '_useradd.html',
	styleUrls: ['_useradd.scss']
})
export class _userAddPage implements OnDestroy, OnInit {
