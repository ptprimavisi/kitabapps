...
// Component
@Component({
	selector: 'page-kitab-list',
	templateUrl: 'kitablist.html',
	styleUrls: ['kitablist.scss']
})
export class kitabListPage implements OnDestroy, OnInit {
	...
	async init() {
		...
		await this.user.set("kitab_foreignKey", this.foreignKey);
