...
// Component
@Component({
	selector: 'page-userlevels-add',
	templateUrl: 'userlevelsadd.html',
	styleUrls: ['userlevelsadd.scss']
})
export class userlevelsAddPage implements OnDestroy, OnInit {
	key: any;
	keyCount: number = 1;
	item: any;
